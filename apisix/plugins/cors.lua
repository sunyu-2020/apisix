...
local schema = {
    ...
    properties = {
        allow_origins = {
            description = "you can use '*' to allow all origins when no credentials," ..
        ...
        allow_methods = {
            description = "you can use '*' to allow all methods when no credentials," ..
                    "'**' to allow forcefully(it will bring some security risks, be carefully)," ..
        ...
        allow_credential = {
            description = "allow client append credential. according to CORS specification," ..
        ...
        allow_origins_by_regex = {
            type = "array",
            description = "you can use regex to allow specific origins when no credentials," ..
...
local function set_cors_headers(conf, ctx)
    ...
    if conf.allow_credential then
        ...
        core.response.set_header("Access-Control-Allow-Credentials", nil)
    end
end
