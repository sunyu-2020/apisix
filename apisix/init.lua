...
function _M.http_init_worker()
    ...
    require("apisix.cert").init_worker()
...
function _M.http_access_phase()
    ...
    -- 消费者授权添加到上下文
    local authorized_consumers = route.value.authorized_consumers
    core.log.info("get authorized_consumers：",core.json.delay_encode(authorized_consumers))
    if authorized_consumers then
        api_ctx.authorized_consumers = authorized_consumers
    end
    -- end
